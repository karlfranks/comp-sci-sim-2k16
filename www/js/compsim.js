...
//SLIDER VARIABLES
var design_slider_x = 1040;
var coding_slider_x = 1040;
var testing_slider_x = 1040;
var documentation_slider_x = 1040;
var slider_max = 1560;
var slider_min = 1040;
...
function draw_assignments_screen(){
  ...
  context.fillText(slider_text, 1000, 70);
  ...
  context.fillText(slider_text, 1000, 270);
  ...
  context.fillText(slider_text, 1000, 470);
  ...
  context.fillText(slider_text, 1000, 670);

  fill_text="Points left to assign: " +points_left;
  context.fillText(fill_text, 1100, 900);
